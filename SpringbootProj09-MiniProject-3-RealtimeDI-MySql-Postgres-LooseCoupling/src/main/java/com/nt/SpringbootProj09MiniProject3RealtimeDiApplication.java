...
public class SpringbootProj09MiniProject3RealtimeDiApplication {

	public static void main(String[] args) throws Exception {

		try (// get access to IOC Container
				ConfigurableApplicationContext ctx = SpringApplication
						.run(SpringbootProj09MiniProject3RealtimeDiApplication.class, args);
			...
			// invoke the b.method
			List<Employee> list = controller.showAllEmployessByDegs(desg1, desg2, desg3);
